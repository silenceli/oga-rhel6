...
class CommandHandlerLinux:
	...
	logging.info("Executing rename command: %s", cmd)
	print cmd
       	ret = subprocess.call(cmd)
	if ret != 0:
...
def test():
    ...
    dd = CommandHandlerLinux("123")
    dd.mkdir("uui")
    dd.set_admin_password("123qaz!@#$")	
